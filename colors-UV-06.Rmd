...
if( !all(file.exists(file_name)) )
{
  ...
  # Save results:
  save(bmed_d2l_lat__blue, bmed_d2l_clim__blue, bmed_d2l_uvb__blue, bmed_d2l_ncol__blue, file=file_name, compress="xz", compression_level=9);
} else
{
  load(file_name); 
}
...
Thus, data supports the following pathways:
...
- *population size* affects "blue" ony through the *number of color categories*;
