...
kable(tmp, row.names=FALSE, col.names=c("With *n_colors*?", "Accuracy", "Sensitivity", "Specificity", "Recall"),
...
tmp <- data.frame("with_ncols" =rep(c("yes", "no"), each=2),
                  ...
                  "specificity"=c(tmp_ncol[ grep("specificity", names(tmp_ncol), fixed=TRUE) ], tmp_noncol[ grep("specificity", names(tmp_noncol), fixed=TRUE) ]),
                  "recall"     =c(tmp_ncol[ grep("recall",      names(tmp_ncol), fixed=TRUE) ], tmp_noncol[ grep("recall",      names(tmp_noncol), fixed=TRUE) ]));
kable(tmp, row.names=FALSE, col.names=c("With *n_colors*?", "Method", "Accuracy", "Sensitivity", "Specificity", "Recall"),
...
paste0(tmp$predictor, " (", round(tmp$importance,2), ")", collapse=", ")
```
...
However, please note that these are based on generalizing from the 80% training to the 20% testing sets.
