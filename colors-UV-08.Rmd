...
- check if we can get more lexical splits (such as greu -> green + blue): SEM/IRT?
...
DiagrammeR::grViz(paste0('
  ...
  Blue [label = "word for blue", fillcolor = "white", color="gray50"]; 

  # the edges:
  edge       [style = "solid", color = "black"];
  UV   -> Perc ;
  Gen  -> Perc [label = "development", color = "red", fontcolor = "red"] ;
  Perc -> Gen  [label = "evolution", color = "blue", fontcolor = "blue"];
  Perc -> Blue [style = "dashed", color = "gray50", fontcolor = "gray50", label = "(H1)"] ;
}
'))
```
