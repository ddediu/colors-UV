...
- redo the mediation analysis with the new flow blue -> n_colors
...
- prediction: put brms, trees, forests, svms together + on the data & training/testing sets
- discuss causality in these models
- check if we can get more lexical splits (such as grue -> green + blue): SEM/IRT?
