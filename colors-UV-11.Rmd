...
```{r}
summary(sem_blue$model_full, fit.measures=TRUE, standardize=TRUE, rsquare=TRUE, estimates=TRUE, ci=TRUE);
...
```{r}
summary(sem_daltonism$model_essential, fit.measures=TRUE, standardize=TRUE, rsquare=TRUE, estimates=TRUE, ci=TRUE);
fitMeasures(sem_daltonism$model_essential);
```
...
```{r}
summary(sem_daltonism$model_essential_subs, fit.measures=TRUE, standardize=TRUE, rsquare=TRUE, estimates=TRUE, ci=TRUE);
